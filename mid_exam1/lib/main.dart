...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        primarySwatch: Colors.purple, // Set the primary color to purple
      ),
...
class FriendsPage extends StatelessWidget {
  final List<Friend> friends = [
    Friend(name: 'Charlie Puth', email: 'charliePuth@gmail.com', description: 'Charles Otto Puth Jr. is an American singer, songwriter, and record producer. His initial exposure came through the viral success of his song covers uploaded to YouTube.', imageUrl: 'assets/images/friend.jpeg'),
    Friend(name: 'Shawn Mendes', email: 'shawnMendes@gmail.com', description: 'Shawn Peter Raul Mendes is a Canadian singer-songwriter. He gained a following in 2013, when he posted song covers on the video sharing platform Vine.', imageUrl: 'assets/images/friend2.jpeg'),
    Friend(name: 'Selena Gomez', email: 'SelenaGomez@gmail.com', description: 'Selena Marie Gomez is an American singer, actress, businesswoman and producer. She has won numerous accolades, including an American Music Award, two MTV Video Music Awards, broke 16 Guinness World Records, and received nominations for two Grammy Awards, a Golden Globe Award, and four Emmy Awards.', imageUrl: 'assets/images/friend3.jpeg'),
  ];
